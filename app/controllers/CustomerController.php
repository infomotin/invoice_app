 ...
 * @category  Controller
 */
class CustomerController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				customer.F_name LIKE ? OR 
				customer.L_name LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("image","F_name","L_name","email","address","phone","sex","dob");
			...
			$this->sanitize_array = array(
				...
				'F_name' => 'sanitize_string',
				'L_name' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","image","F_name","L_name","email","address","phone","sex","dob");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'image' => 'required',
