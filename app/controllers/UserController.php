...
class UserController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array("user.id", 
			...
			"user.email", 
			"user.role", 
			"user_role.role_name AS user_role_role_name", 
			"user.phone");
		...
		$db->join("user_role", "user.role = user_role.id", "INNER");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("image","f_name","l_name","username","email","password","role","phone");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","image","f_name","l_name","username","role","phone");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'image' => 'required',
