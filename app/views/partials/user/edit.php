                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-f_name"  value="<?php  echo $data['f_name']; ?>" type="text" placeholder="Enter F Name"  required="" name="f_name"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-l_name"  value="<?php  echo $data['l_name']; ?>" type="text" placeholder="Enter L Name"  required="" name="l_name"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-role" name="role"  placeholder="Select a value ..."    class="custom-select" >
                                                                    ...
                                                                    <?php
                                                                    $rec = $data['role'];
                                                                    $role_options = $comp_model -> user_role_option_list_2();
