                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-invoice_number" name="invoice_number"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $selected = $this->set_field_selected('invoice_number',$value, "IVN".time());
                                                    ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-taxt_percentage"  value="<?php  echo $this->set_field_value('taxt_percentage',""); ?>" type="number" placeholder="Enter Taxt Percentage" step="1"  required="" name="taxt_percentage"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-discount_amount"  value="<?php  echo $this->set_field_value('discount_amount',""); ?>" type="number" placeholder="Enter Discount Amount" step="0.1"  required="" name="discount_amount"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
